                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            {!! Form::select(
                                'synctype',
                                [
                                    'orders' => __('New Orders'),
                                    'created' => __('Items Created'),
                                    'updated' => __('Items Updated'),
                                    'categories' => __('Categories Added / Updated'),
                                    'error' => __('Error Log'),
                                ],
                                null,
                                [
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change', '#synctype', function() {
