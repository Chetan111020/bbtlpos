...
class NotificationTemplate extends Model
{
    ...
    public static function customerNotifications()
    {
        return [
            'new_sale' => [
                ...
                'extra_tags' => ['{business_name}', '{business_logo}', '{contact_name}', '{contact_address}', '{invoice_number}','{transaction_date}','{invoice_date}','{delivered_to}','{shipping_address}', '{invoice_url}', '{total_amount}', '{paid_amount}', '{due_amount}', '{cumulative_due_amount}', '{due_date}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}']
            ],
        
            'sell_return' => [
                'name' => __('Credit Memos'),
            ...
            'payment_reminder_new' => [
                'name' =>  __('Reminder For All Invoice'),
                'extra_tags' => ['{business_name}', '{business_logo}', '{contact_name}', '{start_date}', '{end_date}','{view}', '{invoice_no}','{invoice_url}','{invoice_number}', '{due_amount}', '{cumulative_due_amount}', '{due_date}']
            ],
            'new_booking' => [
            ...
            'new_lead' => [
                'name' =>  __('New Lead'),
                'extra_tags' => ['{business_name}', '{business_logo}']
            ],
        ];
    }
    ...
    public static function supplierNotifications()
    {
        return [
            ...
            'vendor_credit_memo' => [
                'name' => __('Vendor Credit Memo'),
                'extra_tags' => ['{business_name}','{order_ref_number}', '{business_logo}', '{contact_name}', '{invoice_number}','{invoice_url}', '{total_amount}', '{paid_amount}', '{due_amount}', '{cumulative_due_amount}', '{due_date}', '{location_name}', '{location_address}', '{location_email}', '{location_phone}', '{location_custom_field_1}', '{location_custom_field_2}', '{location_custom_field_3}', '{location_custom_field_4}']
            ],
            'payment_paid' => [
    ...
    public static function defaultNotificationTemplates($business_id = null)
    {
        $notification_template_data = [
            ...
            [
                'business_id' => $business_id,
                'template_for' => 'sell_return',
                'email_body' => '<p>Dear {contact_name},</p>

                    <p>Your credit memo is {invoice_number}<br />
                    Total amount: {total_amount}<br />
                    Paid amount: {received_amount}</p>
