    ...
    public function getSupplierStockReport($supplier_id)
    {
        ...
        $product_stocks =  Datatables::of($query)
                            ...
                            ->editColumn('stock_price', function ($row) {
                                ...
                                $stock_price = $current_stock * $pp;

                                return '<span class="display_currency stock-price"  data-orig-value="' . $stock_price . '" data-currency_symbol=true >' .number_format( $stock_price,2) . '</span> ';
                            })
                            ->editColumn('current_stock', function ($row) {
                                ...
                                return '<span data-is_quantity="true" class="display_currency stock"  data-currency_symbol=false  data-orig-value="' . $current_stock . '">' . round($current_stock,2) . '</span> ' . $row->product_unit;
                            });
