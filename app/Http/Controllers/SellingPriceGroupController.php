                ...
                ->addColumn(
                    'action',
                     function ($row) {
                        ...
                        {
                            $html = '<button data-href="'.action('SellingPriceGroupController@edit', [$row->id]).'" class="btn btn-xs btn-primary btn-modal" data-container=".view_modal"><i class="glyphicon glyphicon-edit"></i> '. __("messages.edit") .'</button>
                            &nbsp;
                            <button data-href="'.action('SellingPriceGroupController@destroy', [$row->id]).'" class="btn btn-xs btn-danger delete_spg_button"><i class="glyphicon glyphicon-trash"></i> '. __("messages.delete") .'</button>
                            &nbsp;';
                            if($row->is_active)
                            {
                                $html.= '<button data-href="'.action('SellingPriceGroupController@activateDeactivate', [$row->id]).'" class="btn btn-xs btn-danger activate_deactivate_spg"><i class="fas fa-power-off"></i>'. __("messages.deactivate") .'</button>';
                            }
                            else
                            {
                                $html.= '<button data-href="'.action('SellingPriceGroupController@activateDeactivate', [$row->id]).'" class="btn btn-xs btn-success activate_deactivate_spg"><i class="fas fa-power-off"></i> '. __("messages.activate") .' </button>';
                            }
