...
class CreateCreditmemoActivityLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('creditmemo_activity_log', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('creditmemo_activity_log');
    }
}
