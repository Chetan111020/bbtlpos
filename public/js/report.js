    ...
    $(
        '#product_purchase_report_form #product_id, #product_purchase_report_form #location_id, #product_purchase_report_form #supplier_id, #product_purchase_report_form #product_pr_date_filter'
    ).change(function() {
        product_purchase_report.ajax.reload();
    });
    ...
    $(
        '#product_sell_report_form #product_id, #product_sell_report_form #location_id, #product_sell_report_form #customer_id'
    ).change(function() {
        product_sell_report.ajax.reload();
        product_sell_grouped_report.ajax.reload();
        product_sell_report_with_purchase_table.ajax.reload();
    ...
    $('#product_sell_report_form #search_product').keyup(function() {
        if (
            ...
            $('#product_sell_report_form #product_id')
                .val('')
                .change();
        }
    });
    ...
    $(
        '#purchase_payment_report_form #location_id, #purchase_payment_report_form #supplier_id, #purchase_payment_report_form #payment_types'
    ).change(function() {
        purchase_payment_report.ajax.reload();
    });
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.is_return = $('#is_return').is(':checked') ? 1 : 0;
                var start = '';
                var end = '';
        ...
        columns: [
            ...
            { data: 'customer_comp', name: 'supplier_business_name', orderable: false},
    ...
    $(document).on('ifChanged', '#is_return', function () {
        sell_payment_report.ajax.reload();
    });
    ...
    balance_report_table = $('#balance_report_tbl').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('#footer_total_stock_price').text(total_stock_price);
            var total_stock_value_by_sale_price = sum_table_col($('#balance_report_tbl'), 'stock_value_by_sale_price');
            $('#footer_stock_value_by_sale_price').text(total_stock_value_by_sale_price);
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            for (var r in data){
                footer_total_open_balance += $(data[r].total_remaining).data('orig-value') ? parseFloat($(data[r].total_remaining).data('orig-value')) : 0;
            }
            $('.footer_total_open_balance').html(__currency_trans_from_en(footer_total_open_balance));
        },
    });
...
function updatePurchaseSell() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('.sell_inc_tax').html(__currency_trans_from_en(data.final_sale_amount, true));
