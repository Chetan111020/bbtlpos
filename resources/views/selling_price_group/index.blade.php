...
<section class="content-header">
    <h1>@lang( 'lang_v1.customer_groups' )
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    ...
    @endif
    @component('components.widget', ['class' => 'box-primary', 'title' => __('Import/Export Customer Group Prices')])
            <div class="row">
                <div class="col-sm-6">
                    <a href="{{action('SellingPriceGroupController@export')}}" class="btn btn-primary">@lang('Import/Export Customer Group Prices')</a>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    ...
                    <p>
                        &bull; @lang('Export Customer group prices.')
                    </p>
                    <p>
