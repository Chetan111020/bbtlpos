...
<script type="text/javascript">
    ...
    $(document).on('change', 'input.return_qty, input.gar_box_return_qty, input.gar_piece_return_qty, input.gar_piece_return_price, #discount_amount, #discount_type', function () {
            update_sell_return_total()
        });
