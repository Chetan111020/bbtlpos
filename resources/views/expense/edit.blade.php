...
<section class="content">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('contact_id', $contacts, $expense->contact_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-4">
  ...
  <div class="payment_row">
        {{-- <input type="hidden" name="payment_id" value="{{$payment_line->id}}"/> --}}
        @foreach ($payment_lines as $payment_line)
            <div style="margin:20px 0;">
                @include('sale_pos.partials.payment_row_form', ['row_index' => $payment_line->id,'payment_line' => $payment_line, 'show_date' => true])
                <hr>
            </div>
        @endforeach
...
$(document).ready( function(){
    ...
    $('.payment_types_dropdown').on('change',function(){
        ...
        $('.payment_details_div[data-type="'+$(this).val()+'"]').removeClass('hide');
    });
    ...
    function calculateExpensePaymentDue() {
        ...
        $('input.payment-amount').each(function(index,element){
