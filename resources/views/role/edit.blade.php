    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'customer.sales_rep', in_array('customer.sales_rep', $role_permissions),
                [ 'class' => 'input-icheck']); !!} Manage Sales Rep
              </label>
            </div>
          </div>
        </div>
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-icheck']); !!} View All Purchase Return
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'purchase_return.view.own', in_array('purchase_return.view.own', $role_permissions),
                    ['class' => 'input-icheck']); !!} View Own Purchase Return
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-icheck']); !!} Create Purchase Return
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-icheck']); !!} Update Purchase Return
                  </label>
                </div>
              </div>
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    ...
                    [ 'class' => 'input-icheck']); !!} Delete Purchase Return
                  </label>
                </div>
              </div>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'list_payment_verified', in_array('list_payment_verified', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.list_payment_verified' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'edit_drafts', in_array('edit_drafts', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __( 'Edit Drafts' ) }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'enable_pos_trasaction_date',  in_array('enable_pos_trasaction_date', $role_permissions), ['class' => 'input-icheck']); !!}
                {{ __('Enable Trasaction Date POS') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'edit_product_qty_from_pos_screen', in_array('edit_product_qty_from_pos_screen', $role_permissions), ['class' => 'input-icheck']); !!}
                {{ __('lang_v1.edit_product_qty_from_pos_screen') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'delete_product_from_pos_screen', in_array('delete_product_from_pos_screen', $role_permissions), ['class' => 'input-icheck']); !!}
                {{ __('lang_v1.delete_product_from_pos_screen') }}
              </label>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'pos.custom_tax', in_array('pos.custom_tax', $role_permissions), ['class' => 'input-icheck']); !!}
                Edit State Tax in POS
              </label>
            </div>
          </div>
        ...
        @endif
         ...
         <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_stale_customer', in_array('view_stale_customer', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.view_stale_customer' ) }}
              </label>
            </div>
          </div>
         <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_sales_by_account_representative', in_array('view_sales_by_account_representative', $role_permissions),
                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.view_sales_by_account_representative' ) }}
              </label>
            </div>
          </div>
        </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'show_gp', in_array('show_gp', $role_permissions) ,
                  [ 'class' => 'input-icheck']); !!} {{ __( 'Show GP Column' ) }}
                </label>
              </div>
            </div>
          </div>
        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'smartcrm.view', in_array('smartcrm.view', $role_permissions) ,
                  [ 'class' => 'input-icheck']); !!} {{ __( 'Follow Up' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'smartcrm.customer_view_all', in_array('smartcrm.customer_view_all', $role_permissions) ,
                  [ 'class' => 'input-icheck']); !!} {{ __( 'Access all customers' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'smartcrm.customer_view_own', in_array('smartcrm.customer_view_own', $role_permissions) ,
                  [ 'class' => 'input-icheck']); !!} {{ __( 'Access own customers only' ) }}
                </label>
              </div>
            </div>
          </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.view', in_array('delivery.view', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Delivery') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.create', in_array('delivery.create', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Add Delivery') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.update', in_array('delivery.update', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Edit Delivery') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.delete', in_array('delivery.delete', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('Delete Delivery') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.exclusive', in_array('delivery.exclusive', $role_permissions), ['class' => 'input-icheck']) !!} {{ __(' Exclusive Delivery Agent') }}
                            </label>
                            <br/><small>(Only Delivery Module will be accessable)</small>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'delivery.viewlocation', in_array('delivery.viewlocation', $role_permissions), ['class' => 'input-icheck']) !!} {{ __('View Delivery Location') }}
                            </label>
                        </div>
                    </div>
                </div>
