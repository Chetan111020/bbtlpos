<div class="modal fade contact_modal" id="contact_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel">
                ...
                <div class="row">
        				...
        				<div class="col-md-6 custom-column customer_fields">
        					...
        					<div class="col-md-6">
        						<div class="form-group">
        							<label>
        								<input type="checkbox" value="1" name="sync" class="nyc" checked>
        				...
        				<div class="col-md-12 custom-column customer_fields">
            					<div class="col-md-12">
					            	<h3 class="f-underline">Account Info</h3>
            					</div>
						<div class="col-md-6 ">
							<div class="form-group">
								<div class="multi-input">
