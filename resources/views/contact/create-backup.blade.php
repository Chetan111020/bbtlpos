        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('expiry_date', null, ['class' => 'form-control dob-date-picker','placeholder' => __('lang_v1.expiry_date'), 'readonly']); !!}
                </div>
            </div>
        </div> 
        <div class="col-md-3">
      ...
      <div class="col-md-3">
        <div class="form-group nyc">
            ...
            <div class="input-group">
                ...
                <!-- Todo -->
                Is NYC<br> <input type="checkbox" value="1" name="is_nyc" class="nyc">
            </div>
        </div>
      </div>
