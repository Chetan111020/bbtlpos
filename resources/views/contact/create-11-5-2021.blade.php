	...
	<div class="modal-content">
		...
		<div class="modal-body">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								{!! Form::text('first_name', null, ['class' => 'form-control', 'id' => 'dbaname', 'required', 'placeholder' => __( 'business.first_name' ) ]); !!}
							</div>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								{!! Form::email('email', null, ['class' => 'form-control','required', 'tabindex' => '11', 'placeholder' => __('business.email')]); !!}
							</div>
						</div>
					</div>
					<div class="col-md-6">
			...
			<div class="modal-footer">
				...
				{{--class="btn btn-primary submit_contact_form">@lang( 'messages.save' )</button>--}}
				<button type="submit" value="submit"
