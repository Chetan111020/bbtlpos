...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('name', __('product.item_code') . ':*') !!}
            <div class="input-group">
              {!! Form::text('name', !empty($duplicate_product->name) ? $duplicate_product->name : null, ['class' => 'form-control', 'id' => 'gen-product-code','required',
        ...
        <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('Category.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('BrandController@create', ['quick_add' => true])}}" title="@lang('category.add_category')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
              </span>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <button type="button" @if(!auth()->user()->can('Category.create')) disabled @endif class="btn btn-default bg-white btn-flat btn-modal" data-href="{{action('BrandController@create', ['quick_add' => true])}}" title="@lang('category.add_sub_category')" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
              </span>
          </div>
        </div>
      </div>
