...
<div class="row">
    ...
    @component('components.widget', ['title' => $product->name])
        ...
        <div class="col-md-12">
            <div class="form-group">
                <a href="/products/update-stock-history/{{$product->id}}" class="btn btn-primary">Reconcile</a>
            </div>
        </div>
    @endcomponent
...
@section('javascript')
   <script type="text/javascript">
        $(document).ready( function(){
            load_stock_history($('#variation_id').val(), $('#location_id').val(),$("#type").val());
        });

       function load_stock_history(variation_id, location_id,type) {
       ...
       $(document).on('change', '#variation_id, #location_id, #type', function(){
            load_stock_history($('#variation_id').val(), $('#location_id').val(),$("#type").val());
       });
