...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    <div class="row">
      ...
      <div class="col-sm-3 not ">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('qty_in_box', __('product.qty_in_box') . ':') !!}
              {!! Form::number('qty_in_box', !empty($duplicate_product->qty_in_box) ? $duplicate_product->qty_in_box : null, ['class' => 'form-control',
