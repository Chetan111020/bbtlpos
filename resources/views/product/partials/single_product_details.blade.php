			...
			<table class="table bg-gray">
				<tr class="bg-green">
				    ...
				    @if(!empty($allowed_group_prices))
			        	<th>@lang('lang_v1.group_prices') <a href="javascript:void(0)" id="toggle" style="color:white"><i id="icon" class="fa fa-caret-down" aria-hidden="true"></i></a></th>
			        @endif
				...
				<tr>
					...
					@endcan
					@if(!empty($allowed_group_prices))
			        	<td class="td-full-width" id="text" class="hide" style="display:none">
