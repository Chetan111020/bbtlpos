        ...
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            ...
            @forelse ($product_variation->variations as $variation)
                ...
                @foreach ($purchase_line as $data)
                    @php 
                        if($data->variation_id == $variation->id) {
                ...
                <tr>
                    ...
                    <td>
                        {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][barcode]', $action == 'edit' ? $barcode : null, ['class' => 'form-control input-sm variation_value_name','required']); !!}
                    </td>
                    <td>
                    ...
                    <td class="{{$class}}">
                        ...
                        {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][sell_price_inc_tax]', @num_format($variation->sell_price_inc_tax), ['class' => 'form-control input-sm hide variable_dsp_inc_tax input_number', 'placeholder' => __('product.inc_of_tax'), 'required']); !!}
                    </td>
                    <td class="{{$class}}">
                    ...
                    <td>
                         {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][on_hand]', $action == 'edit' ? $quantity : null, ['class' => 'form-control input-sm variation_value_name']); !!}
                    </td>
                    <td>
                        <div class="input-group row">
                            <div class="col-md-3  zero-padding-right">
                                {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][aisle]', $action == 'edit' ? $aisle : null, ['class' => 'form-control input-sm variable_location', 'placeholder'=>'A']); !!}
                            </div>
                            <div class="col-md-3 zero-padding-left zero-padding-right">
                                {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][rack]', $action == 'edit' ? $rack : null, ['class' => 'form-control input-sm variable_location', 'placeholder'=>'R']); !!}
                            </div>
                            <div class="col-md-3 zero-padding-left zero-padding-right">
                                {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][shelf]', $action == 'edit' ? $shelf : null, ['class' => 'form-control input-sm variable_location', 'placeholder'=>'S']); !!}
                            </div>
                            <div class="col-md-3 zero-padding-left ">
                                {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][bin]', $action == 'edit' ? $bin : null, ['class' => 'form-control input-sm variable_location', 'placeholder'=>'B']); !!}
                            </div>
                        </div>
                    </td>
                    <td>
