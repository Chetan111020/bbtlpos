...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="item_code" id="gen-product-code" class="form-control" placeholder="Item Code" required>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="sku" id="gen-bar-code" class="form-control" placeholder="Barcode Number" required>
                    <span class="input-group-btn">
                    <button type="button" class="btn btn-default bg-white btn-flat btn-modal" id="generate-bar-code" onclick="barcode()" ><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                'placeholder' => __('product.qty_box')]); !!}
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                {!! Form::label('case_qty',  __('lang_v1.weight') . ':') !!}
                {!! Form::text('case_qty', !empty($duplicate_product->case_qty) ? $duplicate_product->caseqty : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.weight')]); !!}
            </div>
        </div>
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {!! Form::number('aisle', !empty($duplicate_product->aisle) ? $duplicate_product->aisle : null, ['class' => 'form-control',
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {!! Form::number('rack', !empty($duplicate_product->rack) ? $duplicate_product->rack : null, ['class' => 'form-control',
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {!! Form::number('shelf', !empty($duplicate_product->shelf) ? $duplicate_product->shelf : null, ['class' => 'form-control',
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            {!! Form::number('bin', !empty($duplicate_product->bin) ? $duplicate_product->bin : null, ['class' => 'form-control',
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            <input type="file" name="main_image" id="upload_main_image" required>
            <small>
                <p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]) <br> @lang('lang_v1.aspect_ratio_should_be_1_1')</p>
            </small>
        </div>
        ...
        <div class="col-sm-12">
            ...
            <div class="text-center">
                <div class="btn-group">
                    ...
                    <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="btn bg-purple">@lang('lang_v1.save_n_add_opening_stock')</button>
                    @endcan
                    <button type="submit" value="save_n_add_another" class="btn bg-maroon">@lang('lang_v1.save_n_add_another')</button>
                    <button type="submit" value="save" class="btn btn-primary">@lang('messages.save')</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    function barcode(){
      document.getElementById('gen-bar-code').value=Math.random().toString(36).substr(2, 9);
    }
</script>
<script type="text/javascript">
