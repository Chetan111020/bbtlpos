    ...
    <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <div class="input-group">
              {!! Form::text('item_code', !empty($duplicate_product->item_code) ? $duplicate_product->item_code : null, ['class' => 'form-control', 'id' => 'gen-product-code','required',
      ...
      <div class="col-sm-3 not ">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('image', __('lang_v1.product_image') . ':') !!}
            {!! Form::file('image', ['id' => 'upload_image', 'placeholder' => 'jpg,jpeg,png accepted' ,'accept' => 'image/*' , 'multiple' => 'true']); !!}
            <small><p class="help-block">@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]) <br> @lang('lang_v1.aspect_ratio_should_be_1_1')</p></small>
          </div>
        </div>
        </div>
