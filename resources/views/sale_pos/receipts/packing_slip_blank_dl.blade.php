                ...
                <tr>
                    <td style="width: 100%;">
                        ...
                        <table style="width: 100%;padding:2px;">
                            ...
                            <tbody id="tableData" style="display:none;"> </tbody>
                            <tbody id="mytable" style="display:nodne;">
                                @php
                                    $mini_cigar_qty = 0;
                                    $regular_cigar_qty = 0;
                                    $mini_cigar = 0;
                                ...
                                @forelse($receipt_details->lines_sorted_by_name as $line)
                                    <tr>
                                        ...
                                        ?>
                                        <td
                                            style="display:none;vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; ">
                                            {{ $sr++ }}
                                        </td>
                                        <td
                                            style="display:none;vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; ">
                                        ...
                                        <td
                                            style="display:none;vertical-align: top;padding-left: 5px;text-align: left; border: 1px solid #808080; ">
                        ...
                        <td style="display:none;">{{ $line['pro_id'] }}</td>
                    </tr>
