                                                ...
                                                <td style="vertical-align: top;padding-left: 5px;text-align: left; ">
                                                    ...
                                                    <b>
                                                        <span
                                                            ...
                                                            : <br> {{ $receipt_details->customer_name }} <br></b></span>
                ...
                <table style="width: 100%;padding:2px;" >
                    <thead  >
                        <tr>
                            ...
                            <td style="font-weight: 700;text-align: left;vertical-align:top;border: 1px solid #808080; border-left: none;">Price</td>
                            <td style="font-weight: 700;text-align: left;vertical-align:top;border: 1px solid #808080; border-right: none;">Subtotal</td>
                        </tr>
                    </thead>
                    <?php
					$sr = 1;
                    ...
                    <tbody id="mytable" >
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top;padding-left: 5px;text-align: left;"><!-- @if(!empty($line['image']))
                                ...
                                @elseif(strpos($line['name'],'TOBACCO')!== false){{$line['name']}}@elseif(strpos($line['name'],'CUBANO')!== false){{$line['name']}}@elseif(strpos($line['name'],'CLEAR')!== false){{$line['name']}}@elseif($line['name'] == 'JUUL PS 3% CLASSIC MENTHOL -BOX OF 8')
                        ...
                        <table style="border: none;">
                            <tr>
                                ...
                                <td style="width: 50%;vertical-align: top;border: none; ">
                                    ...
                                    @foreach($receipt_details->payments as $payment)</td>
                            <tr>
...
details.forEach(function (a) {
    ...
    this[a.product].subtotal += parseInt(a.subtotal);
