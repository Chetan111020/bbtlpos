                        ...
                        <tr>
                            ...
                            <td>
                                <table style="margin-bottom: 55px;">
                                    ...
                                    <tr>
                                        <th style="display:none;width:86%; text-align: right !important;">
                                            Subtotal (Excl Tax):
                                        </th>
                                        <td class="text-right" style="display:none;">
                                    ...
                                    @foreach ($tax_details as $tr)
                                        {{-- <tr>
                                            ...
                                            <th style="text-align: right !important;display:none;">
                                                {{ $tr['name'] }}:
                                            </th>
                                            <td class="text-right" style="display:none;">
                                                $ {{ $tr['tax'] }}
                                    ...
                                    @if (!empty($receipt_details->shipping_charges))
                                        <tr>
                                            <th style="width:70% ; text-align: right !important;display:none;">
...
<script type="text/javascript">
    ...
    function renove() {
        ...
        k += `<tr style="display:none;">
                    ...
                    <th></th>
                    <th></th>
                    <th class="text-center hide" >Total QTY:<br/>{{ $total_qty }}</th>
                    <th class="text-center hide" >Total Products: ` + sr + `</th>
                    <th class="text-center hide" >Total Unit<br/>Price:<br/>${{ number_format($total_unit_price, 2) }}</th>
                    <th class="text-center hide" >Total Unit<br/>Tax:<br/>${{ number_format($total_unit_tax, 2) }}</th>
                    <th class="text-center hide" >Net Total:<br/>${{ number_format($total_sub, 2) }}</th>
                </tr>`;
        k += '</tbody>';
