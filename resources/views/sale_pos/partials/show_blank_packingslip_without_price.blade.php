...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12 text-right" >
            @auth
            <button type="button" class="btn btn-primary no-print " id="send_message"
                 aria-label="Email"><i class="fas fa-envelope"></i> Send Message
            </button>
            <button type="button" class="btn btn-primary no-print  hide" id="email_invoice"
        ...
        if(tid != "")
        {
            ...
            $.ajax({
                ...
                data: {
                    number: number,
                    tid: tid,
                    // receipt_type : 'blank_slip_without_price',
                },
                beforeSend: function() {
                    toastr.warning('Sending message, please wait ...');
                },
                success: function(result) {
