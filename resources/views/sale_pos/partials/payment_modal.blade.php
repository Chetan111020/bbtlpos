	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">@lang('Finalize Order')</h4>
			</div>
			<div class="modal-body">
				<div class="row ">
					...
					<div class="col-md-12">
						...
						<div class="raw">
							<div class="col-md-12">
								<input id="priority_order" name="priority_order" type="checkbox" data-toggle="toggle" data-onstyle="info" data-offstyle="warning" @if(!empty($transaction) && $transaction->priority_order == 1) checked @endif>
                                <label for="priority_order" class="form-check-label">Set as priority order</label>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary" id="pos-save">@lang('Finalize & Print')</button>
				<button type="submit" name="finalize_no_print" id="finalize_no_print" value="finalize" class="btn btn-primary">@lang('Finalize')</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
