...
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_4' ) {{ 'hide' }} @endif" data-type="custom_pay_4" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_4", __('lang_v1.transaction_no')) !!}
            {!! Form::text("payment[$row_index][transaction_no_4]", $payment_line['transaction_no'], ['class' => 'form-control', 'placeholder' => __('lang_v1.transaction_no'), 'id' => "transaction_no_4_$row_index"]); !!}
		</div>
	</div>
</div>
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_5' ) {{ 'hide' }} @endif" data-type="custom_pay_5" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_5", __('lang_v1.transaction_no')) !!}
            {!! Form::text("payment[$row_index][transaction_no_5]", $payment_line['transaction_no'], ['class' => 'form-control', 'placeholder' => __('lang_v1.transaction_no'), 'id' => "transaction_no_5_$row_index"]); !!}
		</div>
	</div>
</div>
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_6' ) {{ 'hide' }} @endif" data-type="custom_pay_6" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_6", __('Bank Name')) !!}
            {!! Form::text("payment[$row_index][transaction_no_6]", $payment_line['transaction_no'], ['class' => 'form-control', 'placeholder' => __('lang_v1.transaction_no'), 'id' => "transaction_no_6_$row_index"]); !!}
		</div>
	</div>
</div>
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_7' ) {{ 'hide' }} @endif" data-type="custom_pay_7" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_7", __('Bank Name')) !!}
            {!! Form::text("payment[$row_index][transaction_no_7]", $payment_line['transaction_no'], ['class' => 'form-control', 'placeholder' => __('lang_v1.transaction_no'), 'id' => "transaction_no_7_$row_index"]); !!}
		</div>
	</div>
</div>
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_8' ) {{ 'hide' }} @endif" data-type="custom_pay_8" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_8", __('lang_v1.transaction_no')) !!}
...
<div class="payment_details_div @if( $payment_line['method'] !== 'custom_pay_9' ) {{ 'hide' }} @endif" data-type="custom_pay_9" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("transaction_no_9", __('lang_v1.transaction_no')) !!}
            {!! Form::text("payment[$row_index][transaction_no_9]", $payment_line['transaction_no'], ['class' => 'form-control', 'placeholder' => __('lang_v1.transaction_no'), 'id' => "transaction_no_9_$row_index"]); !!}
		</div>
	</div>
</div>