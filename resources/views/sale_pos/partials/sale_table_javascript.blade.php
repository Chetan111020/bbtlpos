...
sell_table = $('#sell_table').DataTable({
        ...
        columns: [
            ...
            { data: 'woocommerce_order_id', name: 'woocommerce_order_id',visible: false},
            ...
            { data: 'shipping_charges',name :'shipping_charges',visible: false },
            { data: 'final_total', name: 'final_total'},
            @can('show_gp')
            { data: 'total_gp', name: 'total_gp', searchable: false,visible: false },
            @endcan
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            var footer_shipping_charges = 0;
            for (var r in data){
                footer_sale_total += $(data[r].final_total).data('orig-value') ? parseFloat($(data[r].final_total).data('orig-value')) : 0;
                footer_shipping_charges += $(data[r].shipping_charges).data('orig-value') ? parseFloat($(data[r].shipping_charges).data('orig-value')) : 0;
            ...
            $('.footer_shipping_charges').html(__currency_trans_from_en(footer_shipping_charges));
