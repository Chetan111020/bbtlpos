...
<div class="row justify-content-center">
	@if(!empty($categories))
		<div class="col-md-10" id="product_category_div">
	...
	<div class="col-sm-4 @if(empty($featured_products)) hide @endif" id="feature_product_div">
		...
		<input type="hidden" class="btn btn-primary btn-flat" id="show_featured_products" readonly>
	</div>
</div>
<br>
<div class="row">
	...
	<div class="col-md-12">
        <div class="eq-height-row" id="featured_products_box" style="display: none;">
            @if(!empty($featured_products))
                @include('sale_pos.partials.featured_products')
            @endif
        </div>
