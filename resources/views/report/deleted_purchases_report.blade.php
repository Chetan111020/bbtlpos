@extends('layouts.app')
@section('title', __( 'Deleted Vendor Bills Report' ))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang( 'Deleted Vendor Bills Report' )
    </h1>
</section>
        ...
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary'])
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="deleted_purchases_report_table">
                        <thead>
                        <tr>
                            <td>Received Date</td>
                            <td>Invoiced Date</td>
...
@section('javascript')
    <script type="text/javascript">
        ...
        function getInventoryItems(date_filter,customer_id) {
            ...
            // alert(customer_id);
            item_inventory_report = $('#deleted_purchases_report_table').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,

                ajax: {
                    url: '{{ url("reports/deleted-purchases-report-list") }}',
                    type: "POST",
                    data: function (d) {
