@extends('layouts.app')
@section('title', __( 'NH CIGAR Report' ))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang( 'NH CIGAR Report' )
    </h1>
</section>
            ...
            @component('components.widget', ['class' => 'box-primary'])
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="vape_report_table">
                        ...
                        <!--        <td><span class="display_currency" id="footer_total_price" data-currency_symbol ="true"></span></td>-->
                        <!--        <td><span class="display_currency" id="footer_total_costing" data-currency_symbol ="true"></span></td>-->
                        <!--    </tr>-->
                        <!--</tfoot>-->
                    </table>
                </div>
    ...
    <script type="text/javascript">
        ...
        function getInventoryItems(date_filter,customer_id) {
            ...
            item_inventory_report = $('#vape_report_table').DataTable({
                ...
                ajax: {
                    url: '{{ url("reports/nh-vape-report-list") }}',
                    type: "POST",
                    data: function (d) {
