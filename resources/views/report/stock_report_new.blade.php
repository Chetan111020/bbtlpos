...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getStockReportNew'), 'method' => 'get', 'id' => 'stock_report_filter_form' ]) !!}
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        {!! Form::label('stock_date_filter', __('report.date_range') . ':') !!}
                        {!! Form::text('stock_date_filter', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'readonly']); !!}
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <br/>
                        <label>
                            {!! Form::checkbox('include_nfs', 1, false,
                            [ 'class' => 'input-icheck', 'id' => 'include_nfs']); !!} Include Inactive
                        </label>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-solid'])
                @include('report.partials.stock_report_table_new')
            @endcomponent
        </div>
    </div>
</section>
...
@section('javascript')
    <script src="{{ asset('js/report_new.js?v2=' . $asset_v) }}"></script>
@endsection