...
<div class="col-xs-12">
    ...
    @endphp
        ...
        <h4 class="text-muted mb-0">
            Sell Price:
            <span class="display_currency" data-currency_symbol="true">{{$data['sell_price']}}</span>
        </h4>
        <h4 class="text-muted mb-0">
            Purchase Price:
            <span class="display_currency" data-currency_symbol="true">{{$data['purchase_price']}}</span>
        </h4>
        <h4 class="text-muted mb-0">
            Gross Profilt:
        ...
        <h3 class="text-muted mb-0">
            ...
            <span class="display_currency" data-currency_symbol="true">{{$data['sell_price']-$data['purchase_price']}}</span>
        </h3>
        ...
        <h3 class="text-muted mb-0" style="display: none;">
            {{ __('report.net_profit') }}: 
            <span class="display_currency" data-currency_symbol="true">{{$data['net_profit']}}</span>
        </h3>
        <small class="help-block" style="display: none;">@lang('lang_v1.gross_profit') + (@lang('lang_v1.total_sell_shipping_charge') + @lang('report.total_stock_recovered') + @lang('lang_v1.total_purchase_discount') + @lang('lang_v1.total_sell_round_off') 
        @foreach($data['right_side_module_data'] as $module_data)
