    ...
    <table class="table table-bordered table-striped" id="stock_report_table">
        <thead>
            <tr>
                ...
                <th>@lang('Total Unit Purchase')</th>
        ...
        <tfoot>
            <tr class="bg-gray font-17 text-center footer-total">
                ...
                <td id="footer_total_solds"></td>
                @can('view_product_stock_value')
                    <td><span id="footer_total_stock_price" class="display_currency" data-currency_symbol="true"></span></td>
                    <td><span id="footer_stock_value_by_sale_price" class="display_currency"
                ...
                @endcan
                <!--<td id="footer_total_solds"></td>-->
                <td id="footer_total_purchaseds"></td>
