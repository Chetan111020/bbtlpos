@extends('layouts.app')
@section('title', __( 'Deleted Vendor Credit Memo Report' ))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang( 'Deleted Vendor Credit Memo Report' )
    </h1>
</section>
        ...
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-primary'])
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="deleted_vendorcreditmemo_report_table">
                        <thead>
                        <tr>
...
@section('javascript')
    <script type="text/javascript">
        ...
        function getInventoryItems(date_filter,customer_id) {
            ...
            // alert(customer_id);
            item_inventory_report = $('#deleted_vendorcreditmemo_report_table').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,

                ajax: {
                    url: '{{ url("reports/deleted-vendorcreditmemo-report-list") }}',
                    type: "POST",
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'total_loose_qty', name: 'total_loose_qty'},
                    { data: 'total_loose_price', name: 'total_loose_price'},
