                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('payment_types', $payment_types, null, ['class' => 'form-control select2', 'id' => 'payment_types' ,'placeholder' => __('messages.all'), 'required']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    ...
                    id="purchase_payment_report_table">
                        <thead>
                            <tr>
                                ...
                                <th class="hide_column">@lang('purchase.supplier')</th>
