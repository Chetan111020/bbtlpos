                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('expiry_date', !empty($document_note->expiry_date) ? @format_date($document_note->expiry_date) : null , ['class' => 'form-control expires-date-picker','placeholder' => __('Select Expire Date'), 'readonly']); !!}
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    //Date picker
    $('.expires-date-picker').datepicker({
        autoclose: true,
    });
