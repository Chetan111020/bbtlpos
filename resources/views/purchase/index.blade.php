...
@section('content')
    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('is_consignment', __('purchase.consigment_status') . ':') !!}
                    {!! Form::select('is_consignment', $consignmentStatuses, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('return_date_range', __('report.return_date_range') . ':') !!}
                    {!! Form::text('return_date_range', null, [
                        'placeholder' => __('lang_v1.select_a_date_range'),
                        'class' => 'form-control',
                        'readonly',
                    ]) !!}
