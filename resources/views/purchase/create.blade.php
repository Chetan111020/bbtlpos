@extends('layouts.app')
<!-- jQuery, jQuery UI (or Bootstrap Datepicker), and Moment.js -->
...
@section('content')
    ...
    <section class="content-header">
        <h1>@lang('Add Vendor Bill') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body"
    ...
    <section class="content">
        ...
        {!! Form::open([
            'url' => action('PurchaseController@store'),
            'method' => 'post',
            ...
            <div class="row">
                <div class="@if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select(
                                'contact_id',
                                [request()->get('contact_id') => request()->get('contact_name')],
                ...
                <div class="@if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                    <div class="form-group">
                        ...
                        {!! Form::text('ref_no', request()->get('ref_no'), ['class' => 'form-control', 'id' => 'ref_no']) !!}
                ...
                <div class="@if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text(
                                'transaction_date',
                                request()->get('transaction_date') ? request()->get('transaction_date') : @format_datetime('now'),
                ...
                <div class="@if (!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::text('received_date', @format_datetime('now'), ['class' => 'form-control', 'required']) !!}
                        </div>
                    </div>
                </div>
                <div style="display:none" class="col-sm-3 @if (!empty($default_purchase_status)) hide @endif">
                    <div class="form-group">
                        {!! Form::label('status', __('purchase.purchase_status') . ':*') !!} @show_tooltip(__('tooltip.order_status'))
                        {!! Form::select('status', $orderStatuses, 'received', [
                ...
                <div class="col-sm-3" style="margin-top:3rem; ">
                    <div class="form-group">
                        <label>
                            {!! Form::checkbox('is_consignment', 1, false, ['id' => 'is_consignment']) !!}
                            {{ __('Is Consignment') }}
                        </label>
                    </div>
                </div>

                <div id="consignment_fields" class="col-sm-6" style="display: none;">
                    <div class="row">
                        <div class="col-sm-6 ">
                            <div class="form-group">
                                {!! Form::label('returnable_days', __('Days') . ':') !!}
                                {!! Form::number('returnable_days', null, [
                                    'class' => 'form-control',
                                    'id' => 'returnable_days',
                                    'min' => 0,
                                ]) !!}
        ...
        @component('components.widget', ['class' => 'box-primary'])
            ...
            <!-- <div class="row" style="margin-bottom: 60px;">
                                                                                                                                                                                                                                                                                                                                                                                                    <div class="table-responsive col-sm-8 col-sm-offset-2" style="z-index: 9999!important; position: absolute; background-color: #fff;">
                                                                                                                                                                                                                                                                                                                                                                                                     <table id="open-datatable" class="table dt-responsive nowrap w-100">
                                                                                                                                                                                                                                                                                                                                                                                                      <thead>
                                                                                                                                                                                                                                                                                                                                                                                                       <tr>
                                                                                                                                                                                                                                                                                                                                                                                                        <th>Code</th>
                                                                                                                                                                                                                                                                                                                                                                                                        <th>Name</th>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-body table-responsive p-0" id="entry_table_row">
                        ...
                        <table style="background:#808080; color:#fff"
                            class="table table-condensed table-bordered text-center table-striped table-head-fixed text-nowrap"
                    ...
                    <hr />
                    {!! Form::hidden('products_ids', request()->get('product_id')) !!}
                    {!! Form::hidden('variations_ids', request()->get('variation_id')) !!}
                            ...
                            <tr>
                                <td colspan="4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('additional_notes', request()->get('additional_notes'), [
                                            'class' => 'form-control',
                                            'rows' => 3,
                                        ]) !!}
                                    </div>
            ...
            <div class="box-body payment_row">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <a href="/purchases" class="btn btn-danger pull-right">@lang('Cancel')</a>
                        ...
                        <button type="submit" name="save_close" style="margin-right: 5px;" value="save_close"
                            id="submit_purchase_form"
                            class="btn btn-primary pull-right save_close">@lang('Save')</button>
                        <button type="submit" name="save_new" style="margin-right: 5px;" value="save_n_add_another"
                            id="submit_purchase_form" class="btn bg-maroon pull-right save_new">@lang('Save & New')</button>
                    </div>
                </div>
            </div>
        @endcomponent
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#is_consignment').on('change', function() {
                if ($(this).is(':checked')) {
                    $('#consignment_fields').show();
                    $('#returnable_days').val(0);
                    calculateReturnDate();
                } else {
                    $('#return_date').val('');
                    $('#returnable_days').val('');
                    $('#consignment_fields').hide();
                }
            });
        });
        ...
        function calculateReturnDate() {
            let days = parseInt($('#returnable_days').val(), 10) || 0; // Default to 0 if no input
            let receivedDateStr = $('#received_date').val();

            if (!isNaN(days) && receivedDateStr) {
                let phpFormat = '{{ session('business.date_format') }}'; // e.g., 'm/d/Y'
                ...
                console.log('Is valid:', receivedDate.isValid());
