...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('brands', __('Brands') . ':') !!}
                {!! Form::select('brands', $brands, 'All', ['class' => 'form-control select2','placeholder' => __('All'), 'id' => __('brands')]); !!}
            </div>
        </div>
    @endcomponent
...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        "ajax": {
            ...
            "data": function ( d ) {
                ...
                if($('#product_sub_category').length) {
                    d.product_sub_category = $('#product_sub_category').val();;
                }
        ...
        columns: [
            ...
            { data: 'picked_by', name: 'au.first_name' },
            { data: 'packed_by', name: 'pb.first_name'  },
            ...
            { data: 'account_rep', name: 'account_rep', orderable: false, "searchable": false},
            { data: 'sales_rep', name: 'sales_rep', orderable: false, "searchable": false},
            { data: 'additional_notes', name: 'additional_notes'},
            { data: 'staff_note', name: 'staff_note'},
            { data: 'shipping_details', name: 'shipping_details'},
            { data: 'table_name', name: 'tables.name', orderable: false, "searchable": false, @if(empty($is_tables_enabled)) visible: false @endif },
            { data: 'waiter', name: 'ss.first_name', orderable: false, "searchable": false, @if(empty($is_service_staff_enabled)) visible: false @endif },
        ],
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            var new_gp = ((footer_sale_total-footer_total_cost-footer_total_discount)*100)/(footer_sale_total-footer_total_discount);
    ...
    $(document).on('change', '#sell_list_filter_location_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status ,#product_sub_category, #created_by, #sales_cmsn_agnt, #service_staffs ,#br_sales_rep ,#br_account_rep ,#shipping_status, #tax_rates',  function() {
        if(pageLength == -1 && is_loaded == 1){
            is_loaded = 0;
            pageLength = 25;
            sell_table.page.len( 25 ).draw();
