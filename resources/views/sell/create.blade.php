	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-primary'])
				...
				<!-- <div class="col-md-3">
					<div class="form-group">
						<div class="input-group">
							...
							<label>dddd</label>
							<br />
							{!! Form::select('contact_id',[], null, ['class' => 'form-control mousetrap', 'id' => 'customer_id', 'placeholder' => 'Enter Customer name', 'required', 'style' => 'width: 100%;']); !!}
				...
				<div class="col-sm-3">
					<div class="form-group">
						<input type="hidden" id="default_customer_id" 
							...
							<input type="hidden" id="default_customer_balance" 
							value="{{ $walk_in_customer['balance'] ?? ''}}" >
						{!! Form::label('transaction_date', __('Customer') . ':*') !!}
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-user"></i>
							</span>
				...
				@if(!empty($status) && $status == 'quotation')
					<input type="hidden" name="status" id="status" value="quotation">
				@else
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-3 @endif">
						<div class="form-group">
		        ...
		        @if(in_array('tables' ,$enabled_modules) || in_array('service_staff' ,$enabled_modules))
		        	<span style="display: none;" id="restaurant_module_span">
			...
			@component('components.widget', ['class' => 'box-primary'])
				...
				<div class="row" style="margin-top: 40px; margin-bottom: 60px;">
					<div id="open-datatable-one" class="table-responsive col-sm-9 col-sm-offset-2" style="z-index: 9999!important; position: absolute; background-color: #fff;margin: -5px 0 0 137px;border:1px solid #000;display:none;">
						<table id="open-datatable" class="table dt-responsive nowrap w-100" style="display:none;">
							<thead>
								<tr>
									<th>Code</th>
									<th>Name</th>
...
@section('javascript')
    ...
    $('#customer_id').on('select2:select', function(e) {
        ...
        $('.addresses').html('<div class="col-md-3"><p style="padding: 0px; margin: 0px;"><b>Address</b></p><p class="p-0 m-0">' + data.address_line_1 + ', ' + data.address_line_2 + ' , ' + data.city + ' , ' + data.state + ' , ' + data.zip_code + '</p></div><div class="col-md-3"><p style="padding: 0px; margin: 0px;"><b>Phone, Email</b></p><p class="p-0 m-0">' + data.mobile + ', ' + data.email + '</p></div><div class="col-md-3"><p style="padding: 0px; margin: 0px;"><b>Contact Person 1</b></p><p class="p-0 m-0">' + data.contact_person_1 + '</p></div><div class="col-md-3"><p style="padding: 0px; margin: 0px;"><b>TAX ID</b></p><p class="p-0 m-0">' + data.tax + '</p></div>');
    });
