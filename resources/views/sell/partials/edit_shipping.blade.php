			...
			<div class="row">
                ...
                <div class="col-md-4 hide">
			         <div class="form-group">
			            ...
			            {!! Form::text('shipping_cost', !empty($transaction->shipping_cost) ? @num_format($transaction->shipping_cost) : '0.00', ['class' => 'form-control','placeholder' => __('Shipping Cost')]); !!}
			        </div>
			    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                       ...
                       {!! Form::text('shipping_charges', !empty($transaction->shipping_charges) ? @num_format($transaction->shipping_charges) : '0.00', ['class' => 'form-control','placeholder' => __('Shipping Charges')]); !!}
                   </div>
               </div>

			    <div class="col-md-4">
			        <div class="form-group">
			            {!! Form::label('delivered_to', __('Tracking Id') . ':' ) !!}
			            {!! Form::text('delivered_to', !empty($transaction->delivered_to) ? $transaction->delivered_to : null, ['class' => 'form-control','placeholder' => __('Tracking Id')]); !!}
			        </div>
			    </div>
