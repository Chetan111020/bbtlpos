            ...
            <div class="col-md-2">
                <div class="form-group">
                  {!! Form::label('surname', __( 'business.prefix' ) . ':') !!}
                    {!! Form::text('surname', $user->surname, ['class' => 'form-control', 'placeholder' =>  __( 'Mr / Mrs / Miss' ) ]); !!}
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                  {!! Form::label('first_name', 'First Name' . ':*') !!}
                    {!! Form::text('first_name', $user->first_name, ['class' => 'form-control', 'required', 'placeholder' => 'First Name' ]); !!}
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
        ...
        @component('components.widget', ['title' => __('lang_v1.roles_and_permissions')])
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="checkbox">
                      <label>
                        {!! Form::checkbox('skip_passcode', 1, !empty($user->skip_passcode), 
                        [ 'class' => 'input-icheck', 'id' => 'skip_passcode']); !!} {{ __( 'Skip Passcode' ) }}
                      </label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <br />
                                <label>
                                    {!! Form::checkbox('sales_rep', 1, $user->sales_rep, [
                                        'class' => 'input-icheck',
                                        'id' => 'sales_rep',
                                    ]) !!} Sales Rep
                                </label>
