      ...
      <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-gorup">
                ...
                <select class="form-control" name="is_horizontal">
                    <option value="0" {{ $barcode->is_horizontal == 0 ? 'selected' : '' }}>Horizontal</option>
                    <option value="1" {{ $barcode->is_horizontal == 1 ? 'selected' : '' }}>Vertical</option>
                </select>
            </div>
        </div>
