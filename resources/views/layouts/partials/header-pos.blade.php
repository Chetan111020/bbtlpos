...
<div style="position: fixed;!important; top: 0px;!important;" class="col-md-12 no-print pos-header">
    ...
    <div class="col-md-6">
      <div class="m-6 mt-5" style="display: flex;">
        <p ><strong>@lang('sale.location'): &nbsp;</strong>
          ...
          <a title="" href="{{ action('HomeController@index')}}" data-toggle="tooltip" class="btn btn-primary btn-flat m-6 btn-xs" data-placement="bottom" data-original-title="Home">
              <strong><i class="fa fa-home" aria-hidden="true"></i></strong>
          </a>
        </p>
        <strong class="pos_ver_info"></strong>
      </div>
    </div>
    <div class="col-md-6">
      <a href="{{url('/sells')}}" title="{{ __('lang_v1.go_back') }}" class="btn btn-info btn-flat m-6 btn-xs m-5 pull-right">
      ...
      <button type="button" id="view_suspended_sales" title="{{ __('lang_v1.view_suspended_sales') }}" class="btn bg-yellow btn-flat m-6 btn-xs m-5 btn-modal pull-right hide" data-container=".view_modal"
