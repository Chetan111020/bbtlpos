<div class="pos-tab-content">
     <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_4_label', __('Custom Payment 4')); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_5_label', __('Custom Payment 5')); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_6_label', __('Custom Payment 6')); !!}
                ...
                <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_7_label', __('Custom Payment 7')); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_8_label', __('Custom Payment 8')); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('custom_payment_9_label', __('Custom Payment 9')); !!}
