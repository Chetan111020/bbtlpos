<tr class="product_row">
    <td>
        ...
        {{$product->sub_sku}}
        <br>
        <input type="hidden" value="{{$product->product_id}}" name="productid" id="productid">
    ...
    <td>
        <input class="form-control" value="{{ $product->last_purchased_price }}" disabled="">
    </td>
    <td>
        ...
        <input type="text" data-row="{{ $row_index }}" data-input="1" id="input_{{ $row_index }}_box1" class="form-control product_quantity input_number input_quantity" value="{{@format_quantity($product->quantity_ordered)}}" name="products[{{$row_index}}][quantity]" 
    ...
    <td><input class="form-control qty_on_hand" name="products[{{$row_index}}][old_qty]" value="{{ $product->formatted_qty_available ?? '0.00'}}" readonly="" id="{{$row_index}}_qty_on_hand"></td>
    <td><input class="form-control new_qty" value="0.00" disabled="" id="{{$row_index}}_new_qty"></td>
    <td><input class="form-control diff_qty" value="0.00" disabled="" id="{{$row_index}}_diff_qty"></td>
    <td>
    ...
    <script type="text/javascript">
            var index =   "{{$row_index}}";
            var qh1 =   $('input#{{$row_index}}__qty_on_hand').val();
            var input = document.getElementById('input_{{ $row_index }}_box1');
            input.focus();
            input.select();
    </script>
</tr>