            ...
            <td style="border: none;">
                        ...
                        <td style="text-align: right;vertical-align: top;">
                            <table style="border: none;width:100% ">
                                ...
                                <td style="vertical-align: top; width:50px;">
                                    <table style="width: 75%; margin-left: 80px;margin-top:25px;"
               ...
               <table style="width: 100%;padding:2px;">
                            ...
                            <tbody id="mytable">
                                ...
                                @endphp
                                @forelse($purchase->po_lines as $line)
                                    <tr>
                                           <?php

                                            $total_qty += $line['quantity'];
                                            $total_unit_price += $line['purchase_price_inc_tax'];
                                            $total_unit_tax += ($line['purchase_price_inc_tax']*$line['quantity']);
                                            $total_sub += ($line['purchase_price_inc_tax']*$line['quantity']);
                                           ...
                                           ?>
                                            ...
                                            <td
                                                style="vertical-align: top;padding-left: 5px;border: 1px solid #808080; ">
                                                {{ $line['product']['name'] }}
                                            </td>
                                             <td
                                                style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; ">
                                            ...
                                            <td style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; ">
                                                $  {{ number_format((float) $line['purchase_price_inc_tax'], 2, '.', '') }}
                                            ...
                                            <td
                                                ...
                                                <!--$ {{  $line['purchase_price_inc_tax'] * $line['quantity'] }}-->
                                            </td>
                                    ...
                                    @endforelse
                                        <td
                                            style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080;border: 0px;">

                                        </td>
                                        <td
                                            style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; border: 0px; font-weight: bold;">
                                            Total Products: <br>   {{ $sr -1 }}
                                        </td>
                                         <td
                                            style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; border: 0px; font-weight: bold;">
                                           	Total QTY:<br>
                                        ...
                                        <td style="vertical-align: top;padding-left: 5px;text-align: center; border: 1px solid #808080; border: 0px; font-weight: bold;">
                                           Total Unit Price:<br>
                                          $ {{ number_format((float) $total_unit_price, 2, '.', '') }}

                                        </td>
                                        <td

                                            style="vertical-align: top;padding-left: 5px;text-align: center; border: 0px;  font-weight: bold;">
                                            Net Total:<br>
                                            $ {{ number_format((float) $total_sub, 2, '.', '') }}
                                        </td>
                        ...
                        <table>
                            <tr >
                                ...
                                <td class="text-right" style="border: 1px solid;">
                                    $ {{ number_format((float) $total_before_tax, 2, '.', '') }}
                                </td>
                            </tr>
                            <!-- Tax -->
                            ...
                            <!-- Shipping Charges -->
                                    ...
                                    <tr >
                                        ...
                                        <td class="text-right" style="border: 1px solid;">
                                           (+) $ {{ number_format((float) $purchase->shipping_charges, 2, '.', '') }}
                                        </td>
                                    </tr>
                                    @else
                                    <tr>
