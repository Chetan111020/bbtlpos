...
@endsection
@section('title', __('Edit Vendor Credit Memo'))
...
<br>
    <h1>@lang('Edit Vendor Credit Memo')</h1>
</section>
			...
			<div class="row">
                        ...
                        <div class="box-body">
                          <div class="row">
                            <div class="col-xs-4">
                                ...
                                {!! Form::number('shipping_charges', $purchase_return->shipping_charges, ['class' => 'form-control', 'id' => 'shipping_charges']); !!}
                            </div>

                            <div class="col-xs-4">
                                {!! Form::label('discount_amount', __('Discount').':') !!}
                                {!! Form::number('discount_amount', $purchase_return->discount_amount, ['class' => 'form-control', 'id' => 'discount_amount']); !!}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('additional_notes', $purchase_return->additional_notes , ['class' => 'form-control', 'rows' => 2]); !!}
                    </div>
                </div>
				<div class="col-md-12">
