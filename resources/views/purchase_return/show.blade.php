<div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="modalTitle"> @lang('lang_v1.purchase_return_details') (<b>@lang('purchase.ref_no'):</b>
                        ...
                        <tbody>
                            ...
                            @foreach ($purchase->purchase_lines as $purchase_line)
                                ...
                                <tr>
                                    ...
                                    <td>{{ @format_quantity($purchase_line->inv_return) }} {{ $unit_name }}</td>
                                    <td>{{ @format_quantity($purchase_line->loose_qty) }} {{ $unit_name }}</td>
                ...
                <div class="col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><b>(-)</b></td>
                            <td><span class="display_currency pull-right"
                                    data-currency_symbol="true">{{ $purchase->discount_amount }}</span></td>
                        </tr>
                        <tr>
