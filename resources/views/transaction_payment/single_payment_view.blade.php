<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="row">
          ...
          <div class="col-xs-6">
            ...
            @elseif($single_payment_line->method == "custom_pay_3")
              ...
              <strong> @lang('lang_v1.transaction_number'):</strong>
              {{ $single_payment_line->transaction_no }}<br>
              @elseif($single_payment_line->method == "custom_pay_4")

              <strong> @lang('lang_v1.transaction_number'):</strong>
              {{ $single_payment_line->transaction_no }}<br>
              @elseif($single_payment_line->method == "custom_pay_5")

              <strong> @lang('Bank Name'):</strong>
              {{ $single_payment_line->transaction_no }}<br>
              @elseif($single_payment_line->method == "custom_pay_6")

              <strong> @lang('Bank Name'):</strong>
              {{ $single_payment_line->transaction_no }}
              @elseif($single_payment_line->method == "custom_pay_7")

              <strong> @lang('lang_v1.transaction_number'):</strong>
              {{ $single_payment_line->transaction_no }}<br>
              @elseif($single_payment_line->method == "custom_pay_8")

              <strong> @lang('lang_v1.transaction_number'):</strong>
              {{ $single_payment_line->transaction_no }}<br>
              @elseif($single_payment_line->method == "custom_pay_9")
          ...
          <div class="col-xs-6">
            ...
            @if(isset($single_payment_line->cash_note))
            <b>@lang('Cash Amount'):</b> {{ $single_payment_line->cash_note }}<br/>
            <br>
            @endif
      ...
      @if(!empty($single_payment_line->parent_id) || !empty($single_payment_line->transaction_id))
      <br>
