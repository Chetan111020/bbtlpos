<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TransactionPaymentController@store'), 'method' => 'post', 'id' => 'transaction_payment_add_form', 'files' => true,  'onsubmit'=>'return checkError()' ]) !!}
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="hidden" name="bill_amt" id="bill_amt" value="{{$payment_line->amount}}">
              {!! Form::text("amount", @num_format($payment_line->amount), ['class' => 'form-control input_number amount', 'required', 'placeholder' => 'Amount','id'=>'amount', 'data-msg-max-value' => __('lang_v1.max_amount_to_be_paid_is', ['amount' => $amount_formated])]); !!}
            </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="input-group">
                ...
                {{-- {!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'percentage' , ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!} --}}
            </div>
          </div>
        </div>
        @php
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('discount_amount', null, ['class' => 'form-control input_number',  'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? @num_format($max_discount) : '']) ]); !!}
