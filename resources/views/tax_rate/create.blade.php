...
<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Add Tax Rule</h4>
        </div>
                ...
                <div class="col-md-6 custom-column">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Tax Name']); !!}
                        </div>
                    </div>
                    {{-- <div class="col-md-6">
                      <div class="form-group">
                  ...
                  <span class="input-group-addon">
                      <i class="fa fa-calendar"></i>
                                ...
                                {!! Form::text('begining_date', null, ['class' => 'form-control', 'id' => 'datepicker', 'placeholder' => __('tax_rate.start_date'), 'readonly']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <span class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                                ...
                                {!! Form::text('end_date', null, ['class' => 'form-control', 'id' => 'datepicker1', 'placeholder' => __('tax_rate.end_date'), 'readonly']); !!}
                            </div>
                        </div>
                    </div>
                    {{-- <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::select('category[]', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : null, ['placeholder' => __('messages.please_select'), 'id' => 'category_id', "style" => "width: 100%;!important;", 'class' => 'form-control select2']); !!}
                                <!-- <select style="width: 100%;!important" name="category[]" id="category" class="form-control" multiple="multiple">
                    ...
                    <span class="input-group-addon">
                        <i class="fa fa-map-marker"></i>
                                ...
                                <!-- <select style="width: 100%;!important;" name="subcategory[]" id="subcategory" class="form-control" multiple="multiple">
                                    <option value="">-select-</option>

                                </select> -->
                                {!! Form::select('subcategory[]', $sub_categories, !empty($duplicate_product->sub_category_id) ? $duplicate_product->sub_category_id : null, ['placeholder' => __('messages.please_select'), 'id' => 'sub_category_id', "style" => "width: 100%;!important;", 'class' => 'form-control select2']); !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group chk-pad">
                            <label><input type="checkbox" value="1" name="inactive">
                                <p class="chechkbox-p"> Item in Active</p></label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label><input type="radio" value="1" name="tax_type" id="stateTax" checked>
                                <p class="chechkbox-p"> State Tax</p></label>
                        </div>
                        <div class="col-md-4">
                            <label><input type="radio" value="2" name="tax_type" id="cityTax">
                                <p class="chechkbox-p"> City Tax</p></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 custom-column" id="state_tax">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('tax', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.tax_percent' )]); !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('taxvalue', __( 'tax_rate.tax_value' ) . ':*') !!}
                            {!! Form::text('taxvalue', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.tax_value' )]); !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('taxvalue_ml', __( 'tax_rate.tax_value' ) . ' per ML:*') !!}
                            {!! Form::text('taxvalue_ml', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.tax_value' ) . " for ML"]); !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            {!! Form::label('every', __( 'tax_rate.every' ) . ':*') !!}
                            {!! Form::text('every', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.every' )]);!!}
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('tax_percent', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.tax_percent' )]); !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('city_tax_value', __( 'tax_rate.tax_value' ) . ':*') !!}
                                    {!! Form::text('city_tax_value', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.tax_value' )]); !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('everycity', __( 'tax_rate.every' ) . ':*') !!}
                                    {!! Form::text('everycity', null, ['class' => 'form-control', 'placeholder' => __( 'tax_rate.every' )]);!!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
