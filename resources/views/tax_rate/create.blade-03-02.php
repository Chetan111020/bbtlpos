        ...
        <div class="col-md-12">
          <div class="form-group">
            {!! Form::label('tax', __( 'tax_rate.tax_percent' ) . ':*') !!}
              {!! Form::text('tax', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.tax_percent' )]); !!}
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            {!! Form::label('taxvalue', __( 'tax_rate.tax_value' ) . ':*') !!}
              {!! Form::text('taxvalue', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.tax_value' )]); !!}
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            {!! Form::label('every', __( 'tax_rate.every' ) . ':*') !!}
              {!! Form::text('every', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.every' )]);!!}
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12 custom-column">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('tax_percent', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.tax_percent' )]); !!}
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            {!! Form::label('cityvalue', __( 'tax_rate.tax_value' ) . ':*') !!}
              {!! Form::text('cityvalue', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.tax_value' )]); !!}
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            {!! Form::label('everycity', __( 'tax_rate.every' ) . ':*') !!}
              {!! Form::text('everycity', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.every' )]);!!}
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            {!! Form::label('first_item_value', __( 'tax_rate.first_item_value' ) . ':*') !!}
              {!! Form::text('first_item_value', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.first_item_value' )]); !!}
          </div>
        </div>
        <div class="col-sm-2">
          <div class="form-group">
            {!! Form::label('second_item_value', __( 'tax_rate.second_item_value' ) . ':*') !!}
              {!! Form::text('second_item_value', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'tax_rate.second_item_value' )]);!!}
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">
